...
//For loop to count from range[0] to range[1]
for (let i = range[0]; i <= range[1]; i++) {
  //if statement to determine which string/int should be logged based on whether number is multiple of range[0] and range[1]
